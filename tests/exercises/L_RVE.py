...
The size of the solid matrix is L_RVE^3. This script analyze a list of RVE size
to study the impact L_RVE / R_pore on the homogenized thermal conductivity.
"""
